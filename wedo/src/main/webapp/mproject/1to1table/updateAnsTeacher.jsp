	   ...
	   $('form').on('submit', function(){
         ...
         $.ajax({
            ...
            success : function(res){
            	alert("수정 성공");
            	location.href="/wedo/select1to1Teacher.do";
            },
            error : function(xhr){
               alert("상태 : " + xhr.status)
            },
 	...
 	<div class="card shadow" >
 		<!-- 
                    ...
                    <div class="card-body " role="alert">
                      <textarea id = "ans_content"class="form-control" id="example-textarea" rows="4" name="notice_content"><%= otoaVo.getOne_ans_content() %></textarea>
                    </div>
                    <p>
                    <button type="submit" class="btn mb-2 btn-primary"style="width: 70px; float: left; margin-left: 1300px;">수정</button>
                    &nbsp;&nbsp;
                    <button type="button" class="btn mb-2 btn-primary" type="reset" style="width: 70px; margin-left: 10px; float: left; " onclick="location.href='/wedo/select1to1Teacher.do'">취소</button>
                    &nbsp;&nbsp;
