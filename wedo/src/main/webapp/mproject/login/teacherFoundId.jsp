...
<body>
	...
	<div class="container">
		<form action="/wedo/idSearchTeacher.do" method = "post" class="needs-validation">

			<h1>강사 아이디찾기</h1>
			<h4>정확한 정보를 기입해주시기 바랍니다.</h4>
			  <div class="social-icons">
                    <a href = "memberFoundId.jsp" id= "user"><img src="img/사용자.png" alt="facebook"></a>
                    <a href = "teacherFoundId.jsp" id= "teacher"><img src="img/강사.png" alt="twitter"></a>
                </div>
