...
<body>
	...
	<div class="container">
		<form action="/wedo/passSearchTeacher.do" method = "post" class="needs-validation">
			...
			<input type="text" class="form-control" id="id" placeholder="Enter ID account" name="id" required>
