...
// 		alert(num + "번글 삭제 ");
  ...
  <body class="vertical  light  ">
                  <div class="card shadow mb-4" style="padding-left: 40px; padding-right: 40px; border: 1px solid; border-radius: 10px; margin: 5%;">
                    ...
                    <div class="card-body" style="border: 1px solid gray; margin-bottom: 20px; border-radius: 10px;">
                     <%=vo.getNotice_content()%><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
                    </div> 
                    <p>
                    <button type="button" class="btn mb-2 btn-primary"style="width: 70px; float: left; margin-left: 77%"  id="modify" >수정</button>
                    &nbsp;&nbsp;
                    <button type="button" class="btn mb-2 btn-primary" type="reset" style="width: 70px; margin-left: 10px; float: left; " id="delete">삭제</button>
                    &nbsp;&nbsp;
                    <button type="button" class="btn mb-2 btn-primary" style="width: 90px; margin-left: 10px; float: left;" onclick="location.href='notice.jsp' ">목록</button>
                    <p></p>
                    <!-- .card-body -->
                  </div> <!-- .card -->
