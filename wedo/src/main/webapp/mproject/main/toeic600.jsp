...
<script>
	function cartInput(input){
		...
		resid = <%= session.getAttribute("idvalue")%>
		//alert(resid);
		//wedo/insertCart.do?classNo=C1
		...
		location.href="wedo/insertCart.do?classNo="+input;
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center" style="margin-top: 85px;">
                    <h1 class="display-3 text-white animated slideInDown">600(입문)</h1>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="../main/img/토익 기초 RC 김진태 강사.png" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">해커스 토익 기본 RC(Part5,6,7)</h5><br>
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" target="_blank" onClick="window.open(this.href, '', 'width=1200, height=800');" href="/wedo/classInfo.do?classNo=C1" >자세히 보기</a></div>
                            </div>
                            
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                         <!--  	<div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/wedo/insertCart.do?classNo=C1">장바구니에 담기</a></div> -->
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" onclick="cartInput('C1')" >장바구니에 담기</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Sale badge-->
                            <!-- Product image-->
                            <img class="card-img-top" src="../main/img/토익 기초 LC 민지원 강사.png" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">토익 입문/기본 LC</h5><br>
                                    <!-- Product reviews-->
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class="bi-star-fill"></div>
                                        <div class="bi-star-fill"></div>
                            ...
                            <!-- Product actions-->
                           <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" target="_blank"  onClick="window.open(this.href, '', 'width=1000, height=800');" href="/wedo/classInfo.do?classNo=C2">자세히 보기</a></div>
                            </div>
                            
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
<!--                                 <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/wedo/insertCart.do?classNo=C2">장바구니에 담기</a></div> -->
							<div class="text-center"><a class="btn btn-outline-dark mt-auto" onclick="cartInput('C2')" >장바구니에 담기</a></div>
                            </div>
                        </div>
                    </div>
                                   </div>
