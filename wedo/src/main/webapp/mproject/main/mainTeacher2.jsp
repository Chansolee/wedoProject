...
<body>
	...
	TeacherVO vo = (TeacherVO) session.getAttribute("teavo");
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">우리두 할 수 있어.</h5>
                                <h1 class="display-3 text-white animated slideInDown">우리두</h1>
                                <p class="fs-5 text-white mb-4 pb-2">우리두 할 수 있어2.</p>
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" > <!-- style="background: rgba(24, 29, 56, .7);" -->
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">우리두 할 수 있어.</h5>
                                <h1 class="display-3 text-white animated slideInDown">토리 Home</h1>
                                <p class="fs-5 text-white mb-4 pb-2">우리두 할 수 있어2.</p>
                              <!--   <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Read More</a>
                                <a href="" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Join Now</a> -->
                            </div>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <a href="https://exam.toeic.co.kr/receipt/examSchList.php" target="_blank">시험일정 바로가기</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <a href="https://exam.toeic.co.kr/common/commonPreLogin.php?returnUrl=/result/scoreList.php" target="_blank">성적확인 바로가기</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <a href="https://www.youtube.com/watch?v=JDud9Dc47dA" target="_blank">시험꿀팁 바로가기</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <a href="https://cafe.naver.com/toeicamp" target="_blank">네이버카페 바로가기</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start text-primary pe-3">We Do</h6>
                    <h1 class="mb-4">우리두란 ?</h1>
                    <p class="mb-4">어쩌고 저쩌고.</p>
                    <p class="mb-4">어쩌고 저쩌고2.</p>
                    <div class="row gy-2 gx-4 mb-4">
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>가나다라</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>가나다라</p>
                        </div>
                    ...
                    <a class="btn btn-primary py-3 px-5 mt-2" href="">더보기</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">강사진 소개</h6>
