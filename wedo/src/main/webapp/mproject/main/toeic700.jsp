                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                           ...
                           <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" target="_blank" onClick="window.open(this.href, '', 'width=1200, height=800');" href="/wedo/classInfo.do?classNo=C3">자세히 보기</a></div>
                            </div>
                            
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" onclick="cartInput('C3')" >장바구니에 담기</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product actions-->
                           <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" target="_blank" onClick="window.open(this.href, '', 'width=1200, height=800');" href="/wedo/classInfo.do?classNo=C4">자세히 보기</a></div>
                            </div>
                            
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" onclick="cartInput('C4')" >장바구니에 담기</a></div>
                            </div>
                        </div>
                    </div>
                </div>
