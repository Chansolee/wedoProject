                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="../usermain/img/토스 기본 세이임 강사.png" alt="..." />
                            <!-- Product details-->
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" target="_blank" onClick="window.open(this.href, '', 'width=1200, height=800');" href="/wedo/classInfoUser.do?classNo=C7" >자세히 보기</a></div>
                            </div>
                            
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/wedo/insertCart.do?classNo=C7">장바구니에 담기</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product actions-->
                           <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" target="_blank" onClick="window.open(this.href, '', 'width=1200, height=800');" href="/wedo/classInfoUser.do?classNo=C8">자세히 보기</a></div>
                            </div>
                            
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/wedo/insertCart.do?classNo=C8">장바구니에 담기</a></div>
                            </div>
                        </div>
                    </div>
                                   </div>
