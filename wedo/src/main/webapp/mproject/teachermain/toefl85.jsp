...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="mainTeacher.jsp" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="../teacherpages/teacherindex.jsp" style="padding-top: 1.5rem !important; padding-bottom: 1.5rem !important; padding-right: 3rem !important;
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center" style="margin-top: 85px;">
                    <h1 class="display-3 text-white animated slideInDown">85점반(중급)</h1>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="../main/img/토플 중급 리딩 양혜미 강사.png" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Hackers TOEFL Reading Intermediate 4th Edition</h5><br>
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" target="_blank" onClick="window.open(this.href, '', 'width=1200, height=800');" href="/wedo/classInfoTeacher.do?classNo=C17" >자세히 보기</a></div>
                            </div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Sale badge-->
                            <!-- Product image-->
                            <img class="card-img-top" src="../main/img/토플 중급 리스닝 Cloud Kim 강사.png" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Hackers TOEFL Listening Intermediate 3rd Edition</h5><br>
                                    <!-- Product reviews-->
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class="bi-star-fill"></div>
                                        <div class="bi-star-fill"></div>
                            ...
                            <!-- Product actions-->
                           <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" target="_blank" onClick="window.open(this.href, '', 'width=1200, height=800');" href="/wedo/classInfoTeacher.do?classNo=C18">자세히 보기</a></div>
                            </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="mainTeacher.jsp">We Do</a> 우리도 할 수 있다!
                    </div>
                    <div class="col-md-6 text-center text-md-end">
                        <div class="footer-menu">
                            <a href="mainTeacher.jsp">Home</a>
