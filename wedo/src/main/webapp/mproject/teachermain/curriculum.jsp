...
<body>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center" style="margin-top: 85px;">
                    <h1 class="display-3 text-white animated slideInDown">커리큘럼</h1>
    ...
    <!-- Section-->
        <section class="py-5">
             <img style="max-width: 60%; margin-left: 370px; height: 1500px;" src="img/curriculum.png" alt="">
        </section>
        <!-- Section End -->
<!--  <iframe name="ifr" src="#" style="width: 100%; height:2500px" scrolling="no"></iframe> -->
    <!-- Footer Start -->
