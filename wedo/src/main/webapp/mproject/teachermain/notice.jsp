...
<!-- 
   ...
   Section
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            Product image
                            <img class="card-img-top" src="../detailpage/img/토플 1.png" alt="..." />
                            Product details
                            <div class="card-body p-4">
                                <div class="text-center">
                                    Product name
                                    <h5 class="fw-bolder">김쫑알 왕초보 기초영문법</h5><br>
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/wedo/classInfo.do?classNo=C1" >자세히 보기</a></div>
                            </div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            Sale badge
                            <div class="badge bg-dark text-white position-absolute" style="top: 0.5rem; right: 0.5rem; margin-top: 165px;">추천</div>
                            Product image
                            <img class="card-img-top" src="../detailpage/img/토플 2.png" alt="..." />
                            Product details
                            <div class="card-body p-4">
                                <div class="text-center">
                                    Product name
                                    <h5 class="fw-bolder">GDC 문법독해</h5><br>
                                    Product reviews
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class="bi-star-fill"></div>
                                        <div class="bi-star-fill"></div>
                            ...
                            Product actions
                           <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/wedo/classInfo.do?classNo=C2">자세히 보기</a></div>
                            </div>
        ...
        -->
        <!-- Navbar End -->
        <iframe name="ifr" src="../notice/nobuttonnotice.jsp" style="width: 100%; height:1000px"></iframe>
    <!-- Footer Start -->
