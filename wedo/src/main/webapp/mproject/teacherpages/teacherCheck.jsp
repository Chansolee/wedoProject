...
$(function(){
	$("#passcheck").on("click",function(){
		...
		passval = <%=session.getAttribute("passvalue")%>
		inputval = $('#upass').val();
				if(passval==inputval){
   ...
   <div class="container">
      <form  class="needs-validation" novalidate onsubmit="return false;">
             ...
             <div class="form-group">
               <label for="upass" >기존 비밀번호</label>
               <input type="password" class="form-control" id="upass" placeholder="Enter password" name="teacher_pass" required>
<%--                <a><%=session.getAttribute("passvalue")%></a> --%>
               <div class="valid-feedback">Valid.</div>
               <div class="invalid-feedback">Please fill out this field.</div>
          </div>
		
            
            <input type="button" value="확인" id="passcheck" class="btn btn-primary" > 
