...
<!--                <label for="upass">새로운 비밀번호</label> -->
...
<!--             <div class="form-group"> -->
<!--                <label for="upass">비밀번호 확인</label> -->
<!--                <input type="password" class="form-control" id="upass2" placeholder="Enter password"  required> -->
<!--                <div class="valid-feedback">Valid.</div> -->
<!--                <div class="invalid-feedback">Please fill out this field.</div> -->
<!--           </div> -->
          ...
          <div class="form-group">
             ...
             <input type="email" class="form-control" id="umail" placeholder="Enter E-mail" name="teacher_mail" required>
             <div class="valid-feedback">Valid.</div>
             <div class="invalid-feedback">Please fill out this field.</div>
          </div>
          ...
          <div class="form-group">
             ...
             <input type="text" class="form-control" id="utel" placeholder="Enter phoneNumber" name="teacher_tel" required>
             <div class="valid-feedback">Valid.</div>
             <div class="invalid-feedback">Please fill out this field.</div>
          </div>
