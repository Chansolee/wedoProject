...
@WebServlet("/classInfoTeacher.do")
public class ClassInfoTeacher extends HttpServlet {
...
//		System.out.println("classNo : " + classNo);
		...
		RequestDispatcher disp = 
				request.getRequestDispatcher("mproject/detailpage/classDetailTeacher.jsp");
