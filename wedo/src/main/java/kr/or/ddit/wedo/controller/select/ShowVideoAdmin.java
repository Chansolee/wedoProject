...
@WebServlet("/showVideoAdmin.do")
public class ShowVideoAdmin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("mproject/detailpage/showVideoAdmin.jsp");
