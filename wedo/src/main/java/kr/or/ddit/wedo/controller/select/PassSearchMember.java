 ...
 */
@WebServlet("/passSearchMember.do")
public class PassSearchMember extends HttpServlet {
...
//		System.out.println(userTel);
		...
		MemberVO res = service.passSearchMember(input);
...
//		request에 결과값을 저장 만약 아이디 비번이 없으면 널값이 들어감 
		...
		String mail = res.getMem_mail(); //membervo타입에서 메일만 빼옴
		String pass = res.getMem_pass();
...
//			System.out.println("메일 송신 완료");
		...
		// view페이지 이동
		RequestDispatcher disp = request.getRequestDispatcher("mproject/login/memberFoundPwComplete.jsp");
